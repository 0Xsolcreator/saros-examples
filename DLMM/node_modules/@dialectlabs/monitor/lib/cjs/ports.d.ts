 ...
 */
export type DataSource<T extends object> = PushyDataSource<T> | PollableDataSource<T>;
/**
...
export type ContextEnrichedPushyDataSource<T extends object> = Observable<Data<T, T>>;
/**
 * A set of transformations that are executed on-top of unbound pushy data source
 * to generate a new notification
 */
export type DataSourceTransformationPipeline<T extends object, R> = (dataSource: ContextEnrichedPushyDataSource<T>) => Observable<R>;
/**
 ...
 */
export type TransformationPipeline<V, T extends object, R> = (upstream: Observable<Data<V, T>>) => Observable<Data<R, T>>;
...
export interface SubscriberRepository {
     ...
     */
    subscribe(onSubscriberAdded?: SubscriberEventHandler, onSubscriberRemoved?: SubscriberEventHandler): any;
}
...
export interface NotificationSink<N extends Notification> {
    push(notification: N, recipients: ResourceId[], metadata: NotificationSinkMetadata): Promise<any>;
}
